<template>
  <div>
    <form @submit.prevent="createUser">
      <BaseInput v-model="formData.fname" label="First name" type="text" class="login-form" />
      <span v-for="error in v$.fname.$errors" :key="error.$uid">{{ error.$message }}</span>

      <BaseInput v-model="formData.lname" label="Last name" type="text" class="login-form" />
      <span v-for="error in v$.lname.$errors" :key="error.$uid">{{ error.$message }}</span>
